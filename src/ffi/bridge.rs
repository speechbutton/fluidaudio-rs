...
impl FluidAudioBridge {
    ...
    pub fn initialize_asr_v2(&self) -> Result<(), String> {
        ...
        if result == 0 {
            ...
            Err("ASR v2 initialization failed".to_string())
        }
    }
    ...
    pub fn initialize_eou(&self, debounce_ms: i32) -> Result<(), String> {
        ...
        if result == 0 {
            ...
            Err("EOU initialization failed".to_string())
        }
    }
    ...
    pub fn eou_feed(&self, samples: &[f32]) -> Result<Option<String>, String> {
        ...
        if result != 0 {
            return Err("EOU feed failed".to_string());
        }
        if text_ptr.is_null() {
            Ok(None)
        } else {
    ...
    pub fn eou_finish(&self) -> Result<String, String> {
        ...
        if result != 0 {
            return Err("EOU finish failed".to_string());
        }
        if text_ptr.is_null() {
            Ok(String::new())
        } else {
    ...
    pub fn eou_reset(&self) -> Result<(), String> {
        ...
        if result == 0 {
            ...
            Err("EOU reset failed".to_string())
        }
    }
