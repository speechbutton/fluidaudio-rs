...
class FluidAudioBridgeInternal {
    ...
    func eouFeed(_ samples: [Float]) throws -> String? {
        ...
        Task {
            do {
                // Set a one-shot EOU callback to capture the transcript
                // when end-of-utterance is detected during this feed.
                var eouText: String?
    ...
    /// Convert raw f32 samples (16kHz mono) to AVAudioPCMBuffer.
